...
CREATE TABLE meta_editions (book_id INTEGER, author_name VARCHAR, title VARCHAR, uuid VARCHAR, filename VARCHAR, FOREIGN KEY (book_id) REFERENCES meta_editions (book_id));
